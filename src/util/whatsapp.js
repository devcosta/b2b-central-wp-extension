function setWindowStore() {
  ...
  window.Store.ReplyUtils =
    window.mR.findModule("canReplyMsg").length > 0 && window.mR.findModule("canReplyMsg")[0];
  ...
  if (
    ...
    if (
      typeof window.mR.findModule("ChatCollection")[0].ChatCollection.findImpl === "undefined" &&
      typeof window.mR.findModule("ChatCollection")[0].ChatCollection._find != "undefined"
    ) {
